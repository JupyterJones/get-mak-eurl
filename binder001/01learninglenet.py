...
# Download data
#below commented out ot generate pipreqs requirementstxt
#      !Caffe/data/mnist/get_mnist.sh
# Prepare data
#      !Caffe/examples/mnist/create_mnist.sh
# back to examples
os.chdir('Caffe/examples')
# In[6]:
...
with open('Caffe/examples/mnist/lenet_auto_train.prototxt', 'w') as f:
    f.write(str(lenet('Caffe/examples/mnist/mnist_train_lmdb', 64)))
...
get_ipython().system('cat Caffe/examples/mnist/lenet_auto_train.prototxt')
...
get_ipython().system('cat Caffe/examples/mnist/lenet_auto_solver.prototxt')
...
get_ipython().system('ls Caffe/examples/mnist/lenet_auto_solver.prototxt')
